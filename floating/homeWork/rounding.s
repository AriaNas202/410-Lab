...
decimalFinder:
	ldr r2, [r0],#1		;get current char in r2
...
processRounding:
	...
	LDR r3, [r0]		;get current char
	CMP r3, #0			;IS current char null?
	ITTTT EQ
	MOVEQ r3, #0x30
	STREQ r3, [r0]		;if yes then we store "0" at the current address
	MOVEQ r3, #0
	STREQ r3, [r0, #1]		;store NULL at next address
