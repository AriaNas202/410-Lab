...
firstNumberMenu:        "Please Insert First Float:", 0xA, 0xD, 0
secondNumberMenu:       "Please Insert Second Float:", 0xA, 0xD, 0
...
fH11:
    ...
    ITTTT EQ
    LDREQ r8, ptr_floatString1              ;get first float string (r8-Address)
    ...
    MOVEQ r7, #4                            ;Change to Subflag 2 (we're done with first number, going to second)               
    ;STREQ r7, [r6]                          
    ITTT EQ 
    ...
    LDR r8, ptr_floatString1                ;get first float string (r8-Address)
