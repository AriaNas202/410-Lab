...
reset_RGB_blinky:
	PUSH  {r4-r12, lr}
	;Im just gonna reset EVERYTHING to be super super safe

	;Reset Clock
	MOV r0, #0xE000
	MOVT r0, #0x400F
	ADD r0, r0, #0x608	;get effective address
	MOV r1, #0x0		;Reset Value
	STR r1, [r0]		;Reset Register

	;Reset GPIO pins to be in Alternate Function Mode
	MOV r0, #0x5000
	MOVT r0, #0x4002
	...
	;Reset Alternate Function to be PWM
	MOV r0, #0x5000
	MOVT r0, #0x4002
	...
	MOV r2, #0x3AD1
	MOVT r2, #0x78E
	MOV	r1, r2				;Reset Value
	STR r1, [r0]			;Reset Register


	;Reset Generator Actions
	MOV r0, #0x9000
	MOVT r0, #0x4002
	...
	MOV r0, #0x9000
	MOVT r0, #0x4002
	ADD r0, r0, #0x0D4		;Get effective address (Generator 2)
	MOV r1, #0x0		;Reset Value
	STR r1, [r0]		;Reset Register
